...
const QUICK_REPLY_TEMPLATES = {
  greeting: {
    items: [
      { type: 'message', action: 'message', label: '🛒 訂瓦斯', text: '我要訂 20kg 瓦斯' },
      { type: 'message', action: 'message', label: '📦 查庫存', text: '查詢目前庫存' },
      { type: 'message', action: 'message', label: '💰 查價格', text: '瓦斯價格多少' },
      { type: 'message', action: 'message', label: '❓ 說明', text: '幫助說明' },
    ],
  },
  help: {
    items: [
      { type: 'message', action: 'message', label: '🛒 訂瓦斯', text: '我要訂瓦斯' },
      { type: 'message', action: 'message', label: '📦 查庫存', text: '查庫存' },
      { type: 'message', action: 'message', label: '📋 查訂單', text: '查詢我的訂單' },
      { type: 'message', action: 'message', label: '📞 聯絡客服', text: '聯絡客服' },
    ],
  },
  order: {
    items: [
      { type: 'message', action: 'message', label: '4kg', text: '我要訂 4kg 瓦斯' },
      { type: 'message', action: 'message', label: '20kg', text: '我要訂 20kg 瓦斯' },
      { type: 'message', action: 'message', label: '50kg', text: '我要訂 50kg 瓦斯' },
    ],
  },
  driver: {
    items: [
      { type: 'message', action: 'message', label: '📋 我的任務', text: '我的任務' },
      { type: 'message', action: 'message', label: '✅ 完成配送', text: '完成配送' },
      { type: 'message', action: 'message', label: '📞 聯絡公司', text: '聯絡公司' },
    ],
  },
  admin: {
    items: [
      { type: 'message', action: 'message', label: '📊 今日報表', text: '今日報表' },
      { type: 'message', action: 'message', label: '📦 庫存狀態', text: '查庫存' },
      { type: 'message', action: 'message', label: '💰 營收統計', text: '營收統計' },
      { type: 'message', action: 'message', label: '👥 業務報表', text: '業務報表' },
    ],
  },
}
