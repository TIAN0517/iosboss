        ...
        return {
          ...
          quickReply: {
            items: [
              ...
              { type: 'message', action: 'message', label: '💰 查價格', text: '瓦斯多少錢' },
            ],
          },
  ...
  private async handleAddressInput(
    ...
    return {
      ...
      quickReply: result.success ? {
        items: [
          { type: 'message', action: 'message', label: '🛒 立即訂購', text: '我要訂瓦斯' },
          { type: 'message', action: 'message', label: '💰 查價格', text: '瓦斯多少錢' },
        ],
      } : undefined,
...
${recommendation ? recommendation + '\n\n' : ''}請問您需要什麼規格的瓦斯？`,
      ...
      quickReply: {
        items: [
          { type: 'message', action: 'message', label: '4kg', text: '4kg' },
          { type: 'message', action: 'message', label: '20kg', text: '20kg' },
          { type: 'message', action: 'message', label: '50kg', text: '50kg' },
        ],
      },
    }
  }
...
請問需要幾桶？`,
      ...
      quickReply: {
        items: [
          { type: 'message', action: 'message', label: '1桶', text: '1桶' },
          { type: 'message', action: 'message', label: '2桶', text: '2桶' },
          { type: 'message', action: 'message', label: `${suggestedQty}桶`, text: `${suggestedQty}桶` },
        ],
      },
    }
  }
...
請確認訂單，回覆「確認」或「取消」`,
      ...
      quickReply: {
        items: [
          { type: 'message', action: 'message', label: '✅ 確認訂單', text: '確認' },
          { type: 'message', action: 'message', label: '❌ 取消', text: '取消' },
        ],
      },
    }
  }
...
還有其他可以幫您的嗎？`,
        ...
        quickReply: {
          items: [
            { type: 'message', action: 'message', label: '🛒 重新訂購', text: '我要訂瓦斯' },
            { type: 'message', action: 'message', label: '📦 查庫存', text: '查庫存' },
          ],
        },
        endConversation: true,
...
${followUp}`,
        ...
        quickReply: {
          items: [
            { type: 'message', action: 'message', label: '📋 查訂單', text: '查訂單' },
            { type: 'message', action: 'message', label: '🛒 繼續訂購', text: '我要訂瓦斯' },
          ],
        },
        endConversation: true,
      }
