...
export function AIAssistant() {
  ...
  const handleSend = async (useStreamArg: boolean | any = true) => {
    // 確保 useStream 是布林值（因為 onClick 會傳入事件對象）
    const useStream = typeof useStreamArg === 'boolean' ? useStreamArg : true
